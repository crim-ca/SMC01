"""Consumer for a AMQP queue. Largely inspired by
...
class BasicConsumer:
    ...
    def connect(self):
        ...
        """
        LOGGER.info("Connecting using parameters %s", self._connection_parameters)
    ...
    def on_channel_open(self, channel):
        ...
        if self._declare_exchange:
            ...
            # Keep the callback chain going but skip the exchange setup.
...
def main():
    ...
    consumer_factory = lambda: BasicConsumer(
        connection_parameters,
        "xpublic",
        "v02.post.model_gem_global.15km.grib2.lat_lon.#",
        "q_anonymous.CRIM.gdps",
